...
var Authorizer = /** @class */ (function () {
    ...
    Authorizer.prototype.initEnforcer = function (s) {
        return __awaiter(this, void 0, void 0, function () {
            var obj, m, _a, _i, _b, sArray, arr, pType;
            var _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        pType = arr.shift();
                        if (!(pType == 'p')) return [3 /*break*/, 4];
                        return [4 /*yield*/, (_c = this.enforcer).addPolicy.apply(_c, arr)];
                    case 3:
                        _e.sent();
                        return [3 /*break*/, 6];
                    case 4:
                        if (!(pType == 'g')) return [3 /*break*/, 6];
                        return [4 /*yield*/, (_d = this.enforcer).addGroupingPolicy.apply(_d, arr)];
                    case 5:
                        _e.sent();
                        _e.label = 6;
                    case 6:
    ...
    Authorizer.prototype.can = function (action, object, domain) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        if (!(this.mode == "auto")) return [3 /*break*/, 7];
                        if (!(this.enforcer === undefined)) return [3 /*break*/, 2];
                        throw Error("Enforcer not initialized");
                    case 2:
                        if (!(domain == undefined)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.enforcer.enforce(this.user, object, action)];
                    case 3: return [2 /*return*/, _a.sent()];
                    case 4: return [4 /*yield*/, this.enforcer.enforce(this.user, domain, object, action)];
                    case 5: return [2 /*return*/, _a.sent()];
                    case 6: return [3 /*break*/, 8];
                    case 7: throw Error("Mode " + this.mode + " not recognized.");
                    case 8: return [2 /*return*/];
                }
            });
        });
    };
    Authorizer.prototype.cannot = function (action, object, domain) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.can(action, object, domain)];
                    case 1: return [2 /*return*/, !(_a.sent())];
                }
            });
        });
    };
    Authorizer.prototype.canAll = function (action, objects, domain) {
        return __awaiter(this, void 0, void 0, function () {
            var i;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.cannot(action, objects[i], domain)];
                    case 2:
                        if (_a.sent()) {
    ...
    Authorizer.prototype.canAny = function (action, objects, domain) {
        return __awaiter(this, void 0, void 0, function () {
            var i;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        if (!(i < objects.length)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.can(action, objects[i], domain)];
                    case 2:
                        if (_a.sent()) {
