...
export declare class Authorizer {
    ...
    requestHeaders: StringKV | undefined;
    ...
    can(action: string, object: string, domain?: string): Promise<boolean>;
    cannot(action: string, object: string, domain?: string): Promise<boolean>;
    canAll(action: string, objects: string[], domain?: string): Promise<boolean>;
    canAny(action: string, objects: string[], domain?: string): Promise<boolean>;
}
export {};
