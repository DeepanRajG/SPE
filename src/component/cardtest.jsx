...
export const Carddd = (props) => {
  ...
  return (
    ...
    <div>
      <Card style={{ height: "auto", borderRadius: "20px", textAlign: "center", cursor: "pointer", boxShadow: "0px 3px 40px #00000029", padding: "10px 11px 20px 11px ", margin: "10px ", width: "350px", display: "flex" }} >
        <CardContent style={{ paddingBottom: "0px", display: "flex" }}>

          <Grid md={5} onClick={cardclk}
            style={{
              height: 114,
          ...
          <Grid md={7} sx={{ display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "500", fontsize: "70px" }}>{props.title[props.int]}</Grid>
        </CardContent>
