...
function App() {
  ...
  // }
  return (
    <Grid container maxWidth="device-width" position="static" >
      <Header name="Afrin" profile={afrin} displayP="none" />
      <Grid container item
        style={{ bg_image, marginTop: { xs: "80px", sm: "80px" } }}
        sx={{
      ...
      >
        ...
        <Grid container  item md={12} lg={12} xl={12} xs={12} sm={12}  sx={{ paddingLeft: "40px", marginBottom: "180px",display: { sm: "none", xs: "none", xl: "block", lg: "block", md: "block" } }} >
          <Slider {...settings}  >
            {Array.from(Array(TITLE.length)).map((_, index) => (
