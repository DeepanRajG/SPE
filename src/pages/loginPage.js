...
const inputStyle = { WebkitBoxShadow: "0 0 0 1000px white inset", };
 ...
 const classes = useStyles();
   return (
        <div sx={{}}>
        <Grid sx={{backgroundColor: "#F5F7FA",padding:{xs:"10px",sm:"10px",md:"20px",lg:"40px",xl:"40px 50px "},maxWidth:"device-width"}}>
                <Grid item  container sx={{ backgroundColor: "white", borderRadius: "20px"}}>
                <Grid item xs={12}sm={6} md={7} lg={7} xl={7} sx={{position:"relative"}}>
                    <Avatar src={logo} style={{width:60,height:55,maxWidth:{xl:60,lg:60,md:60,xs:40,sm:40}, maxHeight:{xl:"55px",md:"55px",lg:"55px",xs:"35px",sm:"35px"},position:"absolute",left:"15px",top:"15px"}} />
                        <Box sx={{height: "auto",maxWidth: {xs:"90%",sm:"89%",md:"85%",lg:"80%",xl:"71%"},padding:{md:"40px 0px 40px 40px",lg:"40px 0px 40px 40px",xl:"40px 0px 40px 40px",xs:"10px 0px 10px 10px",sm:"20px 0px 20px 20px"}}} component="img" src={doctor} />
                    </Grid>
                    <Grid item  xs={12}sm={6} md={5} lg={5} xl={5} sx={{ height: "auto", width:"100%",marginTop:{xs:"20px",sm:"20px",md:"100px",lg:"150px",xl:"150px"},marginLeft:{sm:"0px",xs:"20px",xl:0,lg:0,md:0},paddingLeft:{xl:"30px"},textAlign:{xs:"center",sm:"center",lg:"left",xl:"left",md:"left"}}}>
          ...
          <TextField
          sx={{alignSelf:"center",maxWidth:{xs:270,sm:250,xl:360},
          ...
          <Grid>
            <Typography
              sx={{
                ...
                color: '#277FFE',
                textDecoration: 'none',
                margin:{xl:'12px 40px 20px 0px',lg:'12px 200px 20px 0px',md:'12px 0px 20px 0px',xs:"10px 0px 10px 50px",sm:"10px 0px 10px 50px"},
